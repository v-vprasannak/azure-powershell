...
online version: https://learn.microsoft.com/powershell/module/az.communication/send-azemailserviceemail
schema: 2.0.0
---

# Send-AzEmailServiceEmail
...
### Send (Default)
```
Send-AzEmailServiceEmail -Endpoint <String> -Message <IEmailMessage> [-ClientRequestId <String>]
...
### SendExpanded
```
Send-AzEmailServiceEmail -Endpoint <String> -ContentSubject <String> -RecipientTo <IEmailAddress[]>
...
### SendViaJsonFilePath
```
Send-AzEmailServiceEmail -Endpoint <String> -JsonFilePath <String> [-ClientRequestId <String>]
 [-OperationId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
### SendViaJsonString
```
Send-AzEmailServiceEmail -Endpoint <String> -JsonString <String> [-ClientRequestId <String>]
 [-OperationId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailAttachment[]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailMessage
Parameter Sets: Send
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailAddress[]
Parameter Sets: SendExpanded
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.EmailService.Models.IEmailMessage
